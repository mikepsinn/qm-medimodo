...
$(function() {
    "use strict";
    //Don't remove qm-hidden-alert from dom
    $('#qm-hidden-alert').on('click', '.close', function (){
       $('#qm-hidden-alert').addClass('hide').removeClass('alert-danger alert-success');
    });
...
function alertMessage(success, message)
{
    ...
    var alert = $("#qm-hidden-alert");
    if (success) {
        className = 'alert-success';
    }

    alert.find('span').text(message);
    alert.removeClass('hide alert-success alert-danger').addClass(className);
}