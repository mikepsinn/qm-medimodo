...
<p id="moodscope-text">Please enter your moodscope credentials</p>
<table id="moodscope-credentials-table">
	<% if (errorMessage!=null) { %>
		<tr><td colspan="2"><span class="formError"><%=errorMessage%></span></td></tr>
	<% } %>
	<tr>
	<td>Username:</td><td><input autocorrect="off" autocapitalize="off" class="focushere" id="moodscope-username" value="<%=username%>"></input></td>
	...
	<tr>
	<td>Password:</td><td><input autocorrect="off" autocapitalize="off" id="moodscope-password" type="password" onkeypress="if(event.which==13) submitMoodscopeCredentials()"></input></td>
	...
	<tr>
	<td colspan="2"><button class="btn" onclick="Connectors.submitMoodscopeCredentials()">Send</button></td>
	</tr>
</table>
