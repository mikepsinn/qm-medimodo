...
<p id="myfitnesspal-text">Please enter your MyFitnessPal credentials</p>
<table id="myfitnesspal-credentials-table">
	<% if (errorMessage!=null) { %>
		<tr><td colspan="2"><span class="formError"><%=errorMessage%></span></td></tr>
	<% } %>
	<tr>
	<td>Username:</td><td><input autocorrect="off" autocapitalize="off" class="focushere" id="myfitnesspal-username" value="<%=username%>"></input></td>
	...
	<tr>
	<td>Password:</td><td><input autocorrect="off" autocapitalize="off" id="myfitnesspal-password" type="password" onkeypress="if(event.which==13) submitLumosityCredentials()"></input></td>
	...
	<tr>
	<td colspan="2"><button class="btn" onclick="Connectors.submitMyFitnessPalCredentials()">Send</button></td>
	</tr>
</table>
