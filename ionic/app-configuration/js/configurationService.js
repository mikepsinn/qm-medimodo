angular.module('starter').factory('configurationService', function($http, $q, $rootScope, $state, qmService, qmLogService, $timeout) {
    ...
    var subMenus = {
        ...
        recordMeasurement: [
            ...
            {
                "title": "Record a Meal",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Foods"},
                "icon": "ion-ios-nutrition-outline"
            },
            {
                "title": "Rate an Emotion",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Emotions"},
                "icon": "ion-happy-outline"
            },
            {
                "title": "Rate a Symptom",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Symptoms"},
                "icon": "ion-ios-pulse"
            },
            {
                "title": "Record a Treatment",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Treatments"},
                "icon": "ion-ios-medkit-outline"
            },
            {
                "title": "Record Activity",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Physical Activity"},
                "icon": "ion-ios-body-outline"
            },
            {
                "title": "Record Vital Sign",
                "stateName": qmStates.measurementAddSearch, "params": {"variableCategoryName": "Vital Signs"},
                "icon": "ion-ios-pulse"
            }
        ],
        overallMood: [
            ...
            },
            {
                ...
                "icon": qmService.ionIcons.history
            },
            {
        ...
        history: [
            ...
            {
                "title": "Emotions",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Emotions"},
                "icon": "ion-happy-outline"
            },
            {
                "title": "Foods",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Foods"},
                "icon": "ion-ios-nutrition-outline"
            },
            {
                "title": "Symptoms",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Symptoms"},
                "icon": "ion-sad-outline"
            },
            {
                "title": "Treatments",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Treatments"},
                "icon": "ion-ios-medkit-outline"
            },
            {
                "title": "Physical Activity",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Physical Activity"},
                "icon": "ion-ios-body-outline"
            },
            {
                "title": "Vital Signs",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Vital Signs"},
                "icon": "ion-ios-pulse"
            },
            {
                "title": "Locations",
                "stateName": qmStates.historyAllCategory, "params": {"variableCategoryName": "Location"},
...
//         }
    ...
    configurationService.getIonIcons = function (searchQuery) {
        ...
        for(var i=0; i < ionIcons.length; i++){
            var iconObject = {name: configurationService.formatIonIconName(ionIcons[i]), value: ionIcons[i], ionIcon: ionIcons[i]};
